...
def index():
    ...
    demo_links = [
        ...
        {
            'url': url_for('task.dismiss_confirmed_freelancer_from_task', task_id=4, freelancer_id=2),
            'label': '➖💀 Отцепить от Задачи номер 4, Фрилансера-Исполнителя номер 2.',
        },
        {
            'url': url_for('task.dismiss_responded_freelancer_from_task', task_id=4, freelancer_id=2),
            'label': '➖💀 Отцепить от Задачи номер 4, Предварительно Откликнувшегося Фрилансера номер 2.',
        },
        {
            'url': url_for('task.dismiss_responded_freelancer_from_task', task_id=4, freelancer_id=3),
            'label': '➖💀 Отцепить от Задачи номер 4, Предварительно Откликнувшегося Фрилансера номер 3.',
        },
    ]
