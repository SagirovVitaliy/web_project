...
def convert_task_status_id_to_label(
        task_status_id,
        simple_form='сделана'
    ):
    '''Перевести id Задачи в человекочитаемые термины
    '''
    ...
    return {
        ...
        PUBLISHED: {
            'сделан':    'Опубликован',
            'сделана':   'Опубликована',
            'сделано':   'Опубликован0',
            'сделаны':   'Опубликованы',
            'сделанный': 'Опубликованный',
            'сделанная': 'Опубликованная',
            'сделанное': 'Опубликованное',
            'сделанные': 'Опубликованные',
        },
        FREELANCERS_DETECTED: {
            'сделан':    'Заинтересовал Фрилансеров',
            'сделана':   'Заинтересовала Фрилансеров',
            'сделано':   'Заинтересовало Фрилансеров',
            'сделаны':   'Заинтересовали Фрилансеров',
            'сделанный': 'Заинтересовший Фрилансеров',
            'сделанная': 'Заинтересовшая Фрилансеров',
            'сделанное': 'Заинтересовшее Фрилансеров',
            'сделанные': 'Заинтересовшие Фрилансеров',
        },
        IN_WORK: {
            'сделан':    'В работе',
            'сделана':   'В работе',
        ...
        STOPPED: {
            ...
            'сделано':   'Остановлена',
            'сделаны':   'Остановлены',
            'сделанный': 'Остановленая',
            'сделанная': 'Остановленая',
            'сделанное': 'Остановленая',
            'сделанные': 'Остановленые',
        },
        IN_REVIEW: {
            'сделан':    'В ревью',
            'сделана':   'В ревью',
        ...
        DONE: {
            'сделан':    'Успешно завершен',
            'сделана':   'Успешно завершена',
            'сделано':   'Успешно завершено',
            'сделаны':   'Успешно завершены',
            'сделанный': 'Успешно завершенный',
            'сделанная': 'Успешно завершенная',
            'сделанное': 'Успешно завершенное',
            'сделанные': 'Успешно завершенные',
        },
    }.get(task_status_id, {}).get(simple_form, '')
